...
'''
    ...
    new_content = before + orders_system + main_part
    
    with open('analytics_server.py', 'w') as f:
        f.write(new_content)
    
    print('✅ System zamówień dodany!')
else:
    print('❌ Nie znaleziono main block') 