...
INSERT INTO ingredients (
    ...
    'Szwecja', true, true, 
    '["roślinne", "bez laktozy", "beta-glukan", "błonnik", "zrównoważone"]',
    '["owies", "gluten"]'
);
...
('pumpkin_seeds_roasted', 'Prażone Pestki Dyni', 'proteins', 3.40, 'g', 559, 30.2, 10.7, 49.1, 6.0, 'Lekko prażone pestki dyni - bogate w cynk', 'Austria', true, true, '["cynk", "magnez", "żelazo", "prostata"]', '[]'),
